...
vae.fit(X_train,X_train, epochs=2,sample_weight=wx, batch_size = 16)
...
tf.keras.models.save_model(encoder,'encoder_6_latentDim_BatchNorm_logVars')
tf.keras.models.save_model(vae,'vae_denselayers_withWeights_6_latentDim_100epoch_BatchNorm_logVars')
