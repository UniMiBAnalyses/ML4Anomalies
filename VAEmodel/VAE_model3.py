...
class Encoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.encoder_layer1 = layers.Dense(128, kernel_initializer=tf.keras.initializers.he_normal(), name='el1')        
        self.encoder_active_layer1 = layers.LeakyReLU(name="encoder_leakyrelu_1")
        
        self.encoder_layer2 = layers.Dense(64, kernel_initializer=tf.keras.initializers.he_normal(), name='el2')
        self.encoder_active_layer2 = layers.LeakyReLU(name="encoder_leakyrelu_2")
        
        self.encoder_layer3 = layers.Dense(32, kernel_initializer=tf.keras.initializers.he_normal(), name='el3')
...
class Decoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.decoder_layer1 = layers.Dense(latent_dim, kernel_initializer=tf.keras.initializers.he_normal(), name='dl1')
        self.decoder_active_layer1 = layers.LeakyReLU(name="decoder_leakyrelu_1")
        
        self.decoder_layer2 = layers.Dense(32, kernel_initializer=tf.keras.initializers.he_normal(), name='dl2')         
        self.decoder_active_layer2 = layers.LeakyReLU(name="decoder_leakyrelu_2")    
        
        self.decoder_layer3 = layers.Dense(64, kernel_initializer=tf.keras.initializers.he_normal(), name='dl3')
        self.decoder_active_layer3 = layers.LeakyReLU(name="decoder_leakyrelu_3")
        
        self.decoder_layer4 = layers.Dense(128, kernel_initializer=tf.keras.initializers.he_normal(), name='dl4')
        self.decoder_active_layer4 = layers.LeakyReLU(name="decoder_leakyrelu_4")
        
        self.dense_output = layers.Dense(original_dim, kernel_initializer=tf.keras.initializers.he_normal(), name='dlout')
        self.decoder_active_output = layers.Activation('linear')
